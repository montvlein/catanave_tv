    ...
    <li className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="w-full flex flex-col justify-between p-4 leading-normal">
            ...
            <div className="flex flex-row gap-4 self-end">
                ...
                <Link href={`/proyectos/${storyboard.slug.current}/${lastChapter.slug.current}`} className="inline-flex items-center gap-2 px-3 py-2 text-sm font-medium text-center text-white bg-indigo-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-indigo-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
